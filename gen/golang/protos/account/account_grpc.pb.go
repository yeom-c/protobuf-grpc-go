...
type AccountServiceClient interface {
	...
	SignUp(ctx context.Context, in *SignUpReq, opts ...grpc.CallOption) (*SignInRes, error)
}
...
func (c *accountServiceClient) SignUp(ctx context.Context, in *SignUpReq, opts ...grpc.CallOption) (*SignInRes, error) {
	out := new(SignInRes)
...
type AccountServiceServer interface {
	...
	SignUp(context.Context, *SignUpReq) (*SignInRes, error)
...
func (UnimplementedAccountServiceServer) SignUp(context.Context, *SignUpReq) (*SignInRes, error) {
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/account/account.proto",
}
